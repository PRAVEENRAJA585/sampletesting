...
export const changeKyrosTheme = (theme) => (dispatch, getState) => {
  const { Kyros } = getState();
  const { settings } = Kyros;
...
export const setDefaultSettings = createAsyncThunk(
  'Kyros/settings/setDefaultSettings',
...
const getDirection = (state) => state.kyros.settings.current.direction;
const getMainTheme = (state) => state.kyros.settings.current.theme.main;
const getNavbarTheme = (state) => state.kyros.settings.current.theme.navbar;
const getToolbarTheme = (state) => state.kyros.settings.current.theme.toolbar;
const getFooterTheme = (state) => state.kyros.settings.current.theme.footer;
...
export const selectKyrosCurrentSettings = ({ kyros }) => kyros.settings.current;

export const selectKyrosCurrentLayoutConfig = ({ kyros }) => kyros.settings.current.layout.config;

export const selectKyrosDefaultSettings = ({ kyros }) => kyros.settings.defaults;

export const selectKyrosThemesSettings = ({ kyros }) => kyros.settings.themes;
