...
import {
  getMyLeaves,
  selectMyLeaves,
  selectMyLeavesSearchText,
  selectMyleavesById,
} from "../store/myLeavesSlice";
    ...
    <div className="w-full flex flex-col min-h-full">
      <KyrosScrollbars className="grow overflow-x-auto">
        <Table stickyHeader className="min-w-xl" aria-labelledby="tableTitle">
          ...
          <TableBody>
            {_.orderBy(data, [order.leaveId, order.direction])
              ...
              .map((n) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{n.leaveType}</TableCell>
                    <TableCell>{n.from}</TableCell>
                    <TableCell>{n.to}</TableCell>
                    {/* <TableCell></TableCell>
                    <TableCell></TableCell> */}
                    <TableCell>{<UserMenu />}</TableCell>
                  </TableRow>
                );
              })}
          </TableBody>
