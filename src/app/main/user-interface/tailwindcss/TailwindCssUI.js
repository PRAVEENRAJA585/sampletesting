        ...
        <div className="flex-auto p-24 sm:p-40">
          <div>
            ...
            <Typography className="mb-16">
              ...
              Kyros includes and uses Tailwind by default and it can be used in any part of the
              theme.
            </Typography>
            ...
            <Typography className="mb-16" component="p">
              Kyros React developed based on Material-UI as ui library.
              <a
                className="mx-4"
              ...
              uses emotion at its core. Therefore the Kyros React supports
              <a
                className="mx-4"
