        ...
        <List>
          ...
          <ListItem>
            <ListItemIcon className="min-w-40">
              <KyrosSvgIcon>material-outline:notifications</KyrosSvgIcon>
            </ListItemIcon>
          ...
          <ListItem>
            <ListItemIcon className="min-w-40">
              <KyrosSvgIcon>material-outline:cloud</KyrosSvgIcon>
            </ListItemIcon>
          ...
          <ListItem>
            <ListItemIcon className="min-w-40">
              <KyrosSvgIcon>material-outline:brightness_high</KyrosSvgIcon>
            </ListItemIcon>
