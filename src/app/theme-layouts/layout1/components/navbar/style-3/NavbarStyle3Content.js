...
import KyrosNavigation from '@kyros/core/KyrosNavigation';
import { navbarCloseMobile } from 'app/store/kyros/navbarSlice';
...
import { selectNavigation } from 'app/store/kyros/navigationSlice';
...
const StyledPanel = styled(KyrosScrollbars)(({ theme, opened }) => ({
    ...
    <ClickAwayListener onClickAway={() => setPanelOpen(false)}>
      <Root className={clsx('flex flex-auto flex h-full', props.className)}>
        <ThemeProvider theme={contrastTheme}>
          <div id="kyros-navbar-side-panel" className="flex shrink-0 flex-col items-center">
