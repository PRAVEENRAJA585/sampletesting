import { useDebounce, usePrevious } from '@kyros/hooks';
...
import {
  selectKyrosCurrentSettings,
  selectKyrosThemesSettings,
  setDefaultSettings,
} from 'app/store/kyros/settingsSlice';
...
function KyrosSettings(props) {
  const dispatch = useDispatch();
  const user = useSelector(selectUser);
  const themes = useSelector(selectKyrosThemesSettings);
    ...
    (_formConfigs, prefix) =>
      Object.entries(_formConfigs).map(([key, formControl]) => {
        ...
        switch (formControl.type) {
          case 'radio': {
            return (
              <Controller
                ...
                control={control}
                render={({ field }) => (
                  <FormControl component="fieldset" className="KyrosSettings-formControl">
          ...
          case 'number': {
            return (
              <div key={target} className="KyrosSettings-formControl">
                <Controller
                  name={target}
                  control={control}
                  render={({ field }) => (
          ...
          case 'group': {
            return (
              <div key={target} className="KyrosSettings-formGroup">
                <Typography className="KyrosSettings-formGroupTitle" color="text.secondary">
                  {formControl.title}
                </Typography>
  ...
  return (
    <Root>
      <div className="KyrosSettings-formGroup">
        <Typography className="KyrosSettings-formGroupTitle" color="text.secondary">
          Layout
        </Typography>
        ...
        <Controller
          ...
          render={({ field }) => (
            <FormControl component="fieldset" className="KyrosSettings-formControl">
              ...
              <RadioGroup {...field} aria-label="Layout Style" className="KyrosSettings-group">
      ...
      <div className="KyrosSettings-formGroup pb-16">
        <Typography className="KyrosSettings-formGroupTitle" color="text.secondary">
          Theme
        </Typography>
      ...
      <Controller
        ...
        render={({ field }) => (
          <FormControl component="fieldset" className="KyrosSettings-formControl">
            ...
            <RadioGroup {...field} aria-label="Layout Direction" className="KyrosSettings-group" row>
...
export default memo(KyrosSettings);
