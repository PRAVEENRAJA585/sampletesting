...
function KyrosNavHorizontalGroup(props) {
...
KyrosNavHorizontalGroup.propTypes = {
...
KyrosNavHorizontalGroup.defaultProps = {};

const NavHorizontalGroup = withRouter(memo(KyrosNavHorizontalGroup));
