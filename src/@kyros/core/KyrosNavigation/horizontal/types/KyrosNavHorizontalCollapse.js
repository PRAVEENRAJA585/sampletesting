...
import { useDebounce } from '@kyros/hooks';
...
function KyrosNavHorizontalCollapse(props) {
            ...
            {({ ref }) => (
              <div ref={ref}>
                <StyledListItem
                  ...
                  aria-owns={opened ? 'menu-kyros-list-grow' : null}
                  aria-haspopup="true"
                ...
                >
                  ...
                  {item.badge && <KyrosNavBadge className="mx-4" badge={item.badge} />}
                  <IconButton
                    disableRipple
                    ...
                    size="large"
                  >
                    <KyrosSvgIcon size={16} className="arrow-icon">
                      {theme.direction === 'ltr'
            ...
            >
              {({ ref, style, placement, arrowProps }) =>
                opened && (
                  ...
                  >
                    <Grow in={opened} id="menu-kyros-list-grow" style={{ transformOrigin: '0 0 0' }}>
                      <Paper
                        className="rounded-8"
                        onMouseEnter={() => handleToggle(true)}
                        onMouseLeave={() => handleToggle(false)}
...
KyrosNavHorizontalCollapse.propTypes = {
...
KyrosNavHorizontalCollapse.defaultProps = {};

const NavHorizontalCollapse = withRouter(memo(KyrosNavHorizontalCollapse));
