...
function KyrosNavVerticalCollapse(props) {
        ...
        >
          ...
          <ListItemText
            ...
            classes={{
              ...
              secondary:
                'text-11 font-medium kyros-list-item-text-secondary leading-normal truncate',
            }}
          />
          ...
          <IconButton
            ...
            size="large"
          >
            <KyrosSvgIcon size={16} className="arrow-icon" color="inherit">
...
KyrosNavVerticalCollapse.propTypes = {
...
KyrosNavVerticalCollapse.defaultProps = {};

const NavVerticalCollapse = KyrosNavVerticalCollapse;
