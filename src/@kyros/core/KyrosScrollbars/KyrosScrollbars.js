...
const KyrosScrollbars = forwardRef((props, ref) => {
  ref = ref || createRef();
...
function mapStateToProps({ kyros }) {
  return {
    customScrollbars: kyros.settings.current.customScrollbars,
  };
}

KyrosScrollbars.propTypes = {
...
export default connect(mapStateToProps, null, null, { forwardRef: true })(
  withRouterAndRef(KyrosScrollbars)
);
