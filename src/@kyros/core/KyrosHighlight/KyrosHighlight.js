...
function KyrosHighlight(props) {
  ...
  const trimCode = useCallback(() => {
    ...
    // can be formatted properly while using kyros-highlight
    // component
...
KyrosHighlight.propTypes = {
  component: PropTypes.node,
};
KyrosHighlight.defaultProps = {
  component: 'code',
};

export default memo(styled(KyrosHighlight)``);
