      ...
      <Link to={item.url || ''} role="button">
        <MenuItem key={item.id}>
          <ListItemIcon className="min-w-40">
            {item.icon ? (
              <KyrosSvgIcon>{item.icon}</KyrosSvgIcon>
            ) : (
          ...
          >
                ...
                _item && (
                  <Link to={_item.url} key={_item.id} role="button">
                    ...
                    >
                      ...
                      >
                        {_item.icon ? (
                          <KyrosSvgIcon>{_item.icon}</KyrosSvgIcon>
                        ) : (
            ...
            >
              <IconButton
                ...
                size="large"
              >
                <KyrosSvgIcon sx={{ color: amber[600] }}>heroicons-solid:star</KyrosSvgIcon>
              </IconButton>
            </Tooltip>
          </motion.div>
        );
...
KyrosShortcuts.propTypes = {};
KyrosShortcuts.defaultProps = {
  variant: 'horizontal',
};

export default memo(KyrosShortcuts);
