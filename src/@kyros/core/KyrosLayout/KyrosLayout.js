...
function KyrosLayout(props) {
  const { layouts } = props;
  const dispatch = useDispatch();
  const settings = useSelector(selectKyrosCurrentSettings);
  const defaultSettings = useSelector(selectKyrosDefaultSettings);
  ...
  // console.warn('::KyrosLayout:: rendered');
...
export default memo(KyrosLayout);
