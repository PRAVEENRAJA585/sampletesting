...
const Root = styled('div')(({ theme }) => ({
  '& .KyrosSearch-container': {
    position: 'relative',
  },

  '& .KyrosSearch-suggestionsContainerOpen': {
    position: 'absolute',
    zIndex: 1,
  ...
  '& .KyrosSearch-suggestion': {
    display: 'block',
  },

  '& .KyrosSearch-suggestionsList': {
    margin: 0,
    padding: 0,
    listStyleType: 'none',
  },
      ...
      {variant === 'basic' ? (
        ...
        <>
          <TextField
            ...
            InputProps={{
              ...
              classes: {
                input: 'KyrosSearch-input py-0 px-16 h-40 md:h-48 ltr:pr-48 rtl:pl-48',
        ...
        <TextField
          ...
          InputProps={{
            ...
            classes: {
              input: 'KyrosSearch-input py-0 px-16 h-48 md:h-64',
            },
          }}
          variant="standard"
          {...other}
  ...
  return (
    <MenuItem selected={isHighlighted} component="div">
      <ListItemIcon className="min-w-40">
        {suggestion.icon ? (
          <KyrosSvgIcon>{suggestion.icon}</KyrosSvgIcon>
        ) : (
        ...
        <div className={clsx('flex items-center w-full', props.className)} ref={popperNode}>
          <Autosuggest
            ...
            theme={{
              ...
              suggestionsList: 'KyrosSearch-suggestionsList',
              suggestion: 'KyrosSearch-suggestion',
            }}
...
KyrosSearch.propTypes = {};
KyrosSearch.defaultProps = {
  navigation: [],
  trigger: (
    <IconButton className="w-40 h-40" size="large">
      <KyrosSvgIcon>heroicons-outline:search</KyrosSvgIcon>
    </IconButton>
  ),
  variant: 'full',
  placeholder: 'Search',
...
export default withRouter(memo(KyrosSearch));
